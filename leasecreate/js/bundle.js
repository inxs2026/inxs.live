...
function generateTimeline(formData, province) {
  ...
  return '<div class="timeline" style="page-break-before:always;break-before:page;page-break-inside:avoid;break-inside:avoid;"><h3 class="timeline-title" style="page-break-after:avoid;break-after:avoid;">Lease Timeline</h3><div class="timeline-track">' +
    events.map(function(e) { return '<div class="timeline-event timeline-' + e.type + '" style="page-break-inside:avoid;break-inside:avoid;"><div class="timeline-dot"></div><div class="timeline-content"><div class="timeline-date">' + fmt(e.date) + '</div><div class="timeline-label">' + e.label + '</div><div class="timeline-desc">' + e.desc + '</div></div></div>'; }).join('') + '</div></div>';
}
...
function generateLease(formData, selectedSchedules) {
  ...
  html += '<div class="lease-section lease-section-term" style="page-break-before:always;break-before:page;"><h2>3. TERM OF TENANCY</h2><p style="page-break-inside:avoid;break-inside:avoid;"><strong>Type:</strong> '+(formData.termType==='fixed'?'Fixed Term':'Month-to-Month (Periodic)')+'</p><p style="page-break-inside:avoid;break-inside:avoid;"><strong>Start Date:</strong> '+escG(formData.startDate)+'</p>'+(formData.termType==='fixed'?'<p style="page-break-inside:avoid;break-inside:avoid;"><strong>End Date:</strong> '+escG(formData.endDate)+'</p>':'')+'<p class="lease-info" style="page-break-inside:avoid;break-inside:avoid;">Termination notice requirements per '+province.legislationShort+':</p><ul style="page-break-inside:avoid;break-inside:avoid;">'+Object.entries(province.terminationNotice).map(function(e){return '<li style="page-break-inside:avoid;break-inside:avoid;">'+formatKey(e[0])+': '+e[1]+'</li>';}).join('')+'</ul></div>';
  ...
  html += '<div class="lease-section lease-section-maintenance" style="page-break-before:always;break-before:page;"><h2>8. MAINTENANCE & REPAIRS</h2><p style="page-break-inside:avoid;break-inside:avoid;">The <strong>Landlord</strong> is responsible for maintaining the rental unit in a good state of repair and in compliance with the '+province.legislationShort+'.</p><p style="page-break-inside:avoid;break-inside:avoid;">The <strong>Tenant</strong> is responsible for:</p><ul style="page-break-inside:avoid;break-inside:avoid;"><li style="page-break-inside:avoid;break-inside:avoid;">Keeping the unit reasonably clean</li><li style="page-break-inside:avoid;break-inside:avoid;">Promptly reporting maintenance issues or damage</li><li style="page-break-inside:avoid;break-inside:avoid;">Repairing or paying for damage caused by the tenant, guests, or pets</li><li style="page-break-inside:avoid;break-inside:avoid;">Not altering the unit without written consent</li></ul>'+(formData.maintenanceNotes?'<p style="page-break-inside:avoid;break-inside:avoid;"><strong>Additional Notes:</strong> '+escG(formData.maintenanceNotes)+'</p>':'')+'</div>';

  html += '<div class="lease-section"><h2>9. LANDLORD\'S RIGHT OF ENTRY</h2><p style="page-break-inside:avoid;break-inside:avoid;">The Landlord may enter only in accordance with the '+province.legislationShort+'. Except in emergencies, the Landlord must provide:</p><ul><li style="page-break-inside:avoid;break-inside:avoid;"><strong>Written notice</strong> of at least 24 hours</li><li style="page-break-inside:avoid;break-inside:avoid;">Entry only between <strong>8:00 AM and 8:00 PM</strong></li><li style="page-break-inside:avoid;break-inside:avoid;">A valid reason as permitted by law</li></ul></div>';

  html += '<div class="lease-section"><h2>10. INSURANCE</h2><p style="page-break-inside:avoid;break-inside:avoid;"><strong>Tenant Insurance:</strong> '+(formData.tenantInsuranceRequired?'Required — Tenant must obtain and maintain renter\'s insurance.':'Recommended but not required.')+'</p><p style="page-break-inside:avoid;break-inside:avoid;">The Landlord\'s insurance does not cover the Tenant\'s personal belongings or liability.</p></div>';
